        ...
        <div className="grid md:grid-cols2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[19px]">
          <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000"
            ...
            <div className="flex items-center gap-3 ">
              <p className="text-black font-bold">Student Pilot <br />License</p>
            </div>
            <p className="text-[#0e0e0e] w-full">
              The <span className="font-bold">Student Pilot License </span>  is the initial license required to begin your flight training. To qualify for this license, you must be at least 
              <span className="font-bold"> 16 years old </span> 
              and proficient in English at the level set by the Civil Aviation Authority of the Philippines. No 
              <span className="font-bold"> Degree</span>  is necessary to obtain this license.
            </p>
          </div>
          <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000"
            className="col-span-1 flex flex-col gap-[14px]  backdrop-blur-sm border border-[#222222] p-5 bg-[#141414]/[20%] rounded-lg">
          ...
          <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000" className="col-span-1 flex flex-col gap-[14px]  backdrop-blur-sm border border-[#222222] p-5 bg-[#141414]/[20%] rounded-lg">
            <div className="flex items-center gap-3 ">
              <p className="text-black font-bold">Instrument Pilot<br />License</p>
            </div>
            <p className="text-[#0e0e0e] w-full">
          ...
          <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000" className="col-span-1 flex flex-col gap-[14px]  backdrop-blur-sm border border-[#222222] p-5 bg-[#141414]/[20%] rounded-lg">
            <div className="flex items-center gap-3 ">
              <p className="text-black font-bold">Flight Instructor<br />License</p>
            </div>
            <p className="text-[#0e0e0e] w-full">
          ...
          <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000" className="col-span-1 flex flex-col gap-[14px]  backdrop-blur-sm border border-[#222222] p-5 bg-[#141414]/[20%] rounded-lg">
            <div className="flex items-center gap-3 ">
              <p className="text-black font-bold">Airline Transport Pilot<br />License</p>
            </div>
            <p className="text-[#0e0e0e] w-full">
              The <span className="font-bold"> Airline Transport Pilot License </span> is the highest license a pilot can 
              achieve, qualifying you to fly professionally for <span className="font-bold"> commercial airlines. </span>
              To obtain this license, you must have at least 1500 flight hours, pass a Class 1 medical exam, hold
              an NTC License, and have at least level 4 english language proficiency.
            </p>
          </div>
          <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000" className="col-span-1 flex flex-col gap-[14px]  backdrop-blur-sm border border-[#222222] p-5 bg-[#141414]/[20%] rounded-lg">
            <div className="flex items-center gap-3 ">
              <p className="text-black font-bold">Type Rating</p>
            </div>
            <p className="text-[#0e0e0e] w-full">
