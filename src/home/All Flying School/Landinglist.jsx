...
function Landinglist() {
    return (
        ...
        <nav className="fixed top-0 z-20 w-full bg-white/30 backdrop-blue-md  px-[24px] xl:px-0">
            ...
            <aside id="logo-sidebar" className="fixed top-20 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white/30 backdrop-blue-md border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
