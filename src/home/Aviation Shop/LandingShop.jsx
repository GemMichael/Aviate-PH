                ...
                <aside id="logo-sidebar" className="top-0 left-0 z-40 w-80 md:w-64 h-screen pt-20 transition-transform sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="h-full px-3 pb-2 overflow-y-auto bg-white dark:bg-black">
                        <ul className="space-y-2 font-medium">
                            ...
                            >
                                <Link to="/Skyaerotrade" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="ms-3">Sky Aerotrade</span>
                                </Link>
                            </li>
                            <li
                                ...
                                className='cursor-pointer'
                            >
                                <Link to="/L3harris" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg className="w-6 h-6 flex-shrink-0 ml-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path d="M21 16v-2l-8-5V2a1 1 0 0 0-2 0v7l-8 5v2l8-2.5V21l-2 1v1l3-1 3 1v-1l-2-1v-7.5l8 2.5Z" />
                                    </svg>
                                    <span className="ms-3">Harris Aviation Solution Philippines Inc.</span>
                                </Link>
                            </li>
                            <li
                                ...
                                className='cursor-pointer'
                            >
                                <Link to="/Pilotgoodies" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg className="w-6 h-6 flex-shrink-0 ml-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path d="M21 16v-2l-8-5V2a1 1 0 0 0-2 0v7l-8 5v2l8-2.5V21l-2 1v1l3-1 3 1v-1l-2-1v-7.5l8 2.5Z" />
                                    </svg>
                                    <span className="ms-3">Pilot Goodies</span>
                                </Link>
                            </li>
                            <li
                            >
                                <Link to="/Pilotstarterpack" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg className="w-6 h-6 flex-shrink-0 ml-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path d="M21 16v-2l-8-5V2a1 1 0 0 0-2 0v7l-8 5v2l8-2.5V21l-2 1v1l3-1 3 1v-1l-2-1v-7.5l8 2.5Z" />
                                    </svg>
                                    <span className="ms-3">Pilot Starter Pack</span>
                                </Link>
                            </li>
                        </ul>
                    </div>
