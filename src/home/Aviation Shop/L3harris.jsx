...
import harrislogo from '../pictures/harrislogo.jpg';
...
function L3harris() {
    return (
        <>
            ...
            <Helmet>
                <title>Harris Aviation Solutions Philippines Inc.</title>
                ...
                <section id="home" className="scroll-pt-32 max-w-[1160px] w-full mx-auto mt-[100px] lg:mt-[150px]  px-[24px] xl:px-0 relative">
                    ...
                    <div className="flex lg:flex-row flex-col-reverse items-center justify-between gap-9">
                        <div data-aos="fade-down-left" data-aos-duration="1000" className="max-w-[694px] w-full flex flex-col gap-4 lg:gap-[32px] ">
                            <div>
                                <h1 className="lg:w-[694px] lg:text-start md:text-center text-transparent bg-clip-text bg-gradient-to-r from-[#841619] to-[#b5191d] text-5xl lg:text-[56px] font-bold via-[#616882] leading-[1.3] mt-12 lg:mt-0">
                                    Harris Aviation Solutions Philippines Inc.
                                </h1>
                            </div>
                            <div className="w-full lg:max-w-[79%]">
                                <p className="text-black lg:text-start md:text-center  leading-[1.5]">
                                    Harris Aviation is a premier provider of high-quality aircraft parts and pilot supplies.
                                </p>
                            </div>
                            <a
                                href="https://www.facebook.com/HarrisAviationSolutions"
                                className="bg-[#841619] hover:bg-[#b5191d] transition-all duration-300 text-white py-3 px-8 rounded-lg text-lg font-semibold shadow-lg" target="_blank" rel="noopener noreferrer">
                                Shop now!
                            </a>

                        </div>
                        <div data-aos="fade-up-left" data-aos-duration="1000" className="hidden lg:block w-full lg:w-[397px] relative">
                            <img className="rounded-lg ml-auto w-full lg:h-[483px] object-cover" src={harrislogo} alt="" />
                        </div>
            ...
            <section id="contact" className="max-w-[1160px] w-full mx-auto mt-40 px-[24px] lg:px-0 " >
                <div data-aos="fade-up" data-aos-duration="1000" className=" bg-gradient-to-r pt-[85px] pb-[35px] px-[40px] lg:px-[59px] from-[#841619] to-[#b5191d] rounded-lg flex-col justify-end items-center gap-[132px] w-full">
                    <div className="flex justify-center items-center flex-col">
                        ...
                        <p className="text-stone-300 font-semibold text-2xl lg:text-4xl">inquiry@harrisaviationph.com</p>
                    </div>
                    <div className="flex flex-col lg:flex-row justify-between w-full mt-[132px] ">
                        <p className="text-white font-bold hidden md:block">Harris Aviation Solutions Philippines Inc.</p>
                        <div className="flex justify-between gap-[19px]">
                            <a href="https://www.facebook.com/HarrisAviationSolutions" className="text-white font-semibold">
                                Facebook
                            </a>
                            <a href="https://www.instagram.com/harrisaviationsolutions?fbclid=IwY2xjawGsu3lleHRuA2FlbQIxMAABHcqiv-DqNQeS9wvZJlBwHVYQDdaE49KL7Ry40n0xWTyU1kkIw7mC0_yhTw_aem_ex6ov9u5RRAO2OOnuTcBNw" className="text-white font-semibold">
                                Instagram
                            </a>
                        </div>
                    </div>
