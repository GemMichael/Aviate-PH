        ...
        <>
            <section className="max-w-[1160px] w-full mx-auto mt-[168px] px-[24px] lg:px-0 ">
                ...
                <div className="relative">
                    <div data-aos="fade-up-left" data-aos-duration="1000" className="grid grid-cols-1 sm:grid-cols-2 w-full gap-4 mt-8">
                        ...
                        <div className="hover:scale-105 transition-transform duration-300 col-span-5 p-4 flex  items-center justify-center border border-zinc-700 rounded-lg bg-white/80 backdrop-blur-md text-black">
                ...
                <div className="relative">
                    <div data-aos="fade-up-left" data-aos-duration="1000" className="grid grid-cols-1 sm:grid-cols-2 w-full gap-4 mt-8">
                        <div className="absolute inset-0 rounded-lg bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-blue-800 via-blue-500 to-blue-400 opacity-20 blur-md sm:blur-lg lg:blur-2xl"></div>
                        <div className="hover:scale-105 transition-transform col-span-5 p-4 flex  items-center justify-center border border-zinc-700 rounded-lg bg-white/80 backdrop-blur-md text-black">
                            <h1 className="text-lg sm:text-xl md:text-2xl">
                                Accreditation
                            </h1>
                        </div>
